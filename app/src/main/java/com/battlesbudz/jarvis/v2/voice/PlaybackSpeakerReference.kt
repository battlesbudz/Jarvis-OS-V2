...
class PlaybackSpeakerReference private constructor(internal val windows: List<FloatArray>) {
    companion object {
        fun fromPcm(pcm: ShortArray, sampleRate: Int): PlaybackSpeakerReference? {
            ...
            return PlaybackSpeakerReference(windows)
        }
    }
}
